# -*- coding: utf-8 -*-
"""KEFI_Israa_Assignment1_Part2_NLTK.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/192WTf5QBEU7WlHY-PLdxaZKlAbhkq9aA
...
def question_four():
    freq = nltk.FreqDist(text1)
    tokens = [w for w in freq if len(w) > 5 and freq[w] > 150]
...
def question_six():
    freq = nltk.FreqDist(text1)
    words = [(freq[w], w) for w in freq if w.isalpha() and freq[w] > 2000]
...
def question_eight():
    ...
    words = [w.lower() for w in text1 if w.isalpha() and w.lower() not in stop_words]
