# -*- coding: utf-8 -*-
"""KEFI_Israa_assignment1_Part1_Regex.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1LiaCAYzRZ13S7wyopv8LaerfCJ3kuC9Z
...
def question_seven():
    ...
    for note in df:
        ...
        if date is None:
            ...
            if m:
                ...
                date = datetime.strptime(f"{day} {month_str} {year}", "%d %b %Y")
        ...
        if date is None:
            ...
            if m:
                ...
                date = datetime.strptime(f"1 {month_str} {year}", "%d %b %Y")
    ...
    dates_series = pd.Series(parsed_dates)
